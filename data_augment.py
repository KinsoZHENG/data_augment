...
def imageOps(func_name, image, label, img_des_path, label_des_path, img_file_name, label_file_name, times=2):
...
opsList = {"randomRotation", "randomColor", "randomCrop"}
...
def threadOPS(img_path, new_img_path, label_path, new_label_path):
    ...
    if os.path.isdir(img_path):
        img_names = natsort.natsorted(os.listdir(img_path))
    else:
        img_names = [img_path]
...
if __name__ == '__main__':
    threadOPS("/home/kinsozheng/Desktop/data_augment/train",
              "/home/kinsozheng/Desktop/data_augment/tmp/train",
              "/home/kinsozheng/Desktop/data_augment/mask",
              "/home/kinsozheng/Desktop/data_augment/tmp/mask")